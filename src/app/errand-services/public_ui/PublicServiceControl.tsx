...
const ServicesControlPanel: React.FC<ServicesControlPanelProps> = ({
  ...
  const handleCreateService = () => {
    if (onCreateService) {
      ...
      // Default behavior or navigation to create service page
      console.log("Create service functionality not implemented");
    }
  };
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                Filter: {getFilterDisplayName(serviceFilter)}
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent
              align="end"
