...
const features = [
  {
    title: "Connect to Service Providers",
    description:
      "Access to hawkers, porters, and helpers for all your service needs in just a few clicks.",
  ...
  {
    title: "Market Shopping Assistant",
    description:
      "Someone to help you navigate local markets and carry your purchases while you shop.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Get help moving your belongings from one place to another with reliable assistance.",
  ...
  },
  {
    ...
    description:
      "Connect with porters to help carry your luggage at stations, airports, and hotels.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Quick delivery services for packages and documents within your city.",
  ...
  },
  {
    ...
    description:
      "Get your groceries delivered to your doorstep by local helpers.",
            ...
            >
              <Card className="bg-white/80 dark:bg-white/10 backdrop-blur-xl border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white h-full overflow-hidden shadow-lg dark:shadow-2xl rounded-2xl">
                ...
                <CardFooter className="flex justify-between pt-3 lg:pt-4 relative z-10">
                  ...
                  <Button
                    className={`${currentFeature.badgeColor} text-white rounded-lg flex items-center gap-2 transition-all hover:gap-3 text-sm lg:text-base`}
                  >
      ...
      <div className="backdrop-blur-lg bg-gradient-to-br from-white/80 to-white/90 dark:from-white/5 dark:to-white/10 p-4 lg:p-6 xl:p-8 rounded-2xl border border-gray-200 dark:border-white/10 shadow-lg dark:shadow-2xl">
        <div className="flex flex-col md:flex-row gap-6 lg:gap-8 items-center">
          ...
          <div className="flex-shrink-0">
            <Button className="bg-teal-600 hover:bg-teal-700 dark:bg-teal-500 dark:hover:bg-teal-600 text-white px-6 py-4 lg:px-8 lg:py-6 text-base lg:text-lg font-medium rounded-xl shadow-md dark:shadow-lg flex items-center gap-2 transition-all hover:gap-3">
